...
namespace Persistence.Configuration
{
    public class ClienteConfig : IEntityTypeConfiguration<Cliente>
    {
        ...
        builder.HasKey(c => c.Id);
            ...
            builder.Property(c => c.Apellido).HasMaxLength(80).IsRequired();
            builder.Property(c => c.FechaNacimiento).IsRequired();
            builder.Property(c => c.Telefono).HasMaxLength(9).IsRequired();
            builder.Property(c => c.Email).HasMaxLength(100);
            builder.Property(c => c.Direccion).HasMaxLength(120).IsRequired();
